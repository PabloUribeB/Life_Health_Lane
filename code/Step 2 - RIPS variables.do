...
global work diag_mental diag_mental2 cons_mental cons_mental2           ///
            cons_mental3 cons_mental4 cons_general cons_general2        ///
            cons_general3 cons_general4
...
gen     cons_mental     = 1 if (cons_psico == 1  |                     ///
                                cons_psiquiatra == 1 | cons_trab_social == 1)
                                
replace cons_mental	    = 0 if (cons_psico != 1  &                     ///
                                cons_psiquiatra != 1 &                 ///
                                cons_trab_social != 1 & service == "consultas")
...
replace cons_mental3	= 0 if (cons_psico != 1 & cons_psiquiatra != 1 ///
                                    & service == "consultas")
...
labvars cons_mental cons_mental2 cons_mental3 cons_mental4              ///
    "cons. psicologo, psiquiatra o social"                              ///
    "cons. psicologo, psiquiatra o social, sin causas de maternidad"    ///
    "cons. psicologo o psiquiatra"                                      ///
    "cons. psicologo o psiquiatra, sin causas de maternidad"
...
* Count number of health services by month and keep one observation per person 
* and date
...
* Replace all values for each person in a single year with the maximum value 
* (1 if happens that year)
...
keep personabasicaid year_RIPS service rethus_sexo nro_servicios     ///
     nro_servicios_np nro_serv_mental* $t_sensitive $work 
...
greshape wide nro_servicios nro_servicios_np nro_serv_mental            ///
              nro_serv_mental2,                                         ///
